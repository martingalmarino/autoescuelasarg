...
const defaultProvinces: Province[] = [
  ...
  { id: '22', name: 'Santiago del Estero', slug: 'santiago-del-estero', schoolsCount: 17 },
  { id: '23', name: 'Tierra del Fuego', slug: 'tierra-del-fuego', schoolsCount: 6 },
  { id: '24', name: 'Tucumán', slug: 'tucuman', schoolsCount: 38 }
]

export default function ProvincesIndex({ provinces = defaultProvinces }: ProvincesIndexProps) {
